...
public class PrincipalView extends JFrame {
	...
	private void addButtons() {
		JLabel balanceLabel = new JLabel("Saldo actual: 0.0 Bs");
		balanceLabel.setBounds(0, 0, 220, 50);
		balanceLabel.setFont(new Font("Sans Serif", Font.BOLD, 20));
		balanceLabel.setHorizontalAlignment(SwingConstants.CENTER);
		panel.add(balanceLabel);

		checkPurse = new CheckPurseButton();
		checkPurse.setBounds(18, 50, 190, 50);
